...
// import img1 from '../../assets/sc_landing_header_home.jpg'
// import img2 from '../../assets/sc_landing_header_web_featured_artists.jpg'
            ...
            <div className="navbar">
                ...
                <div className='background-overlay'>
                    <div className='discover'>
                        ...
                        <p> SoundCloud Go+ lets you listen offline, ad-free, with over </p>
                        <p> 150 million tracks — and growing.</p>
                    </div>
                    <div className='next'>
                        <h1>What's next in music is first on SoundCloud</h1>
                        <p>Upload your first track and begin your journey. SoundCloud gives you </p>
                        <p> space to create, find your fans, and connect with other artists.</p>
                    </div>
                </div>
            </div>
        </div >
